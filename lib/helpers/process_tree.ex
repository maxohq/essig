# vendored from https://github.com/jbsf2/process-tree/tree/main (v 0.1.3)
defmodule Essig.Helpers.ProcessTree.OtpRelease do
  @moduledoc false
...
defmodule Essig.Helpers.ProcessTree do
  alias Essig.Helpers.ProcessTree.OtpRelease
